...
contract IEpisode is IContents{
    ...
    function setImage(bytes16 _image, uint256 _index) external;
    function setImages(bytes16[] _images) external;
    function changeImageOrder(uint256 _oldOrder, uint256 _newOrder) external;
}